...
export function getTechNavItems(techSlug: string) {
  return [
    { title: 'Phases', href: `/${techSlug}/phases`, description: 'Browse all learning phases' },
...
/* ─── Storage keys ────────────────────────────────────────────────────────── */
export const PROGRESS_STORAGE_KEY = 'interviewer-app-progress-v2'
export const BASKET_STORAGE_KEY = 'interviewer-app-baskets-v2'
...
/* ─── Content paths ───────────────────────────────────────────────────────── */
export const CONTENT_DIR = 'content/technologies'
