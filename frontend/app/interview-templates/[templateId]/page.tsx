...
export default function TemplateDetailPage() {
  ...
  const basketId = params.templateId as string
        ...
        <div className="mb-6">
          ...
          {!mounted ? (
            ...
            <div className="rounded-xl border border-border bg-muted/20 p-8 text-center">
              ...
              <Link href="/interview-templates" className="text-sm text-muted-foreground hover:text-primary mt-1 block">
                Back to templates
              </Link>
            </div>
          ) : (
                  ...
                  {activeFilter ? (
                    ...
                    <>
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        Browse lessons and click &ldquo;Add to template&rdquo; on any question or lesson.
                      </p>
                      <Link href="/phases">
